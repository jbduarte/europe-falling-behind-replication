...
def construct_dataset(data, smooth=True, country='US'):
    """
    ...
    data_temp['L_PROD'] = data_temp['output'] / data_temp['H']
    ...
    sample = sample[sample.sector != 'tot'][['year', 'sector', 'LS', 'L_PROD_normalized']]
