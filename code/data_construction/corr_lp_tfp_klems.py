...
# read data
growth_acc_db = pd.read_csv('../Data/Raw Data/growth accounts.csv')
lp_db = pd.read_excel('../Outputs/Data/lp_KLEMS_data.xlsx')
...
with open('../Figures/corr_lp_tfp_klems.tex', 'w') as f:
